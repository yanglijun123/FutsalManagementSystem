<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="redyellowcard.aspx.cs" Inherits="五人制足球.redyellowcard" %>
        ...
        <div class="content">
            ...
            <div class="rightcontent" style="border: 1px solid #aaa; border-radius: 5px; height: 420px; margin-top: 10px;">
                ...
                <div class="login" style="margin-top:20px">
                    ...
                    <%-- 累计红牌数--%>
                    <div style="margin-top: 10px;">
                        <asp:Label ID="Label5" runat="server" Text="红牌" CssClass="td4"></asp:Label>
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="td2"></asp:TextBox>
                        <span style="color: red; margin-left: 0;" class="td3"></span>
                    </div>
                    <%-- 累计黄牌数--%>
                    <div style="margin-top: 10px;">
                        <asp:Label ID="Label4" runat="server" Text="黄牌" CssClass="td4"></asp:Label>
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="td2"></asp:TextBox>
                        <span style="color: red; margin-left: 0;" class="td3"></span>
                    </div>
                    <%-- 停赛期--%>
                    <div style="margin-top: 10px;">
                        <asp:Label ID="Label6" runat="server" Text="停赛" CssClass="td4"></asp:Label>
                    ...
                    <table style="margin-top: 5px;width:630px;text-align:center">
                        <tr>
                            <td colspan="3" class="td1" style="text-align: center; margin-top: 10px;">
                                <asp:Button ID="Button1" runat="server" Text="添加处罚" CommandName="yes" BorderWidth="5" OnClick="Button1_Click" OnClientClick="return confirm('是否确定添加处罚公告？');" />
                            </td>
                        </tr>
                    </table>
                </div>
