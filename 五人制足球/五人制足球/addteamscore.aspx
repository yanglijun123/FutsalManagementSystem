<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addteamscore.aspx.cs" Inherits="五人制足球.addteamscore" %>
            ...
            <div class="rightcontent" style="border: 1px solid #aaa; border-radius: 5px; height: 420px; margin-top: 10px;">
                ...
                <div class="login" style="margin-top: 20px;">
                    ...
                    <div style="margin-top: 10px;">
                        <asp:Label ID="Label3" runat="server" Text="轮次" CssClass="td1"></asp:Label>
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="td2" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                        <span style="color: red; margin-left: 0;" class="td3"></span>
                    </div>
                    <%-- 球队名--%>
                    <div style="margin-top: 10px;">
                        <asp:Label ID="Label4" runat="server" Text="球队" CssClass="td4"></asp:Label>
                        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="td2" AutoPostBack="True" ></asp:DropDownList>
                        <span style="color: red; margin-left: 0;" class="td3"></span>
                    </div>
                    <%-- 得分--%>
                    <div style="margin-top: 10px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 10px;">
                        <asp:Label ID="Label6" runat="server" Text="失分" CssClass="td4"></asp:Label>
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="td2"></asp:TextBox>
                        <span style="color: red; margin-left: 0;" class="td3"></span>
                    </div>
                    <div style="margin-top: 10px; margin-bottom: 10px;">
                        <asp:Label ID="Label1" runat="server" Text="积分" CssClass="td4"></asp:Label>
                        <asp:DropDownList ID="DropDownList3" runat="server" CssClass="td2">
                    ...
                    <table style="margin-top: 5px; width: 630px; text-align: center">
                        <tr>
                            <td colspan="3" class="td1" style="text-align: center; margin-top: 10px;">
                                <asp:Button ID="Button1" runat="server" Text="添加球队得分" BorderWidth="5" OnClick="Button1_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
