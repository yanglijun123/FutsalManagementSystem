...
namespace 五人制足球
{
    public partial class redyellowedit : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            DataTable dt = db.read("select playerorder from TeamPlayer where playername='" + playername + "'", CommandType.Text).Tables[0];
            string playerorder = dt.Rows[0]["playerorder"].ToString();
            string playerredcard = ((TextBox)GridView1.Rows[e.RowIndex].Cells[3].Controls[0]).Text;
            string playeryellowcard = ((TextBox)GridView1.Rows[e.RowIndex].Cells[4].Controls[0]).Text;
            string stopperiod = ((TextBox)GridView1.Rows[e.RowIndex].Cells[5].Controls[0]).Text;
            db.command("update RedYellowCards set playerredcard='" + playerredcard + "',playeryellowcard='" + playeryellowcard + "',stopperiod='" + stopperiod + "' where turn=" + turn + " and playerorder='" + playerorder + "'", CommandType.Text);
