<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeagueStanding---Team.aspx.cs" Inherits="五人制足球.LeagueStanding___Team" %>
...
<head runat="server">
    ...
    <link href="css/LegueStanding---Team.css" rel="stylesheet" />
</head>
<body>
        ...
        <div class="content">
            ...
            <div class="rightcontent">
                <div class="compitioncontent">
                    ...
                    <div>
                        <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="4" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
                            <ItemTemplate>
                                <table>
                                    <tr style="border: 5px solid red">
                                        <td class="xiangxi"><%#Eval("teamname") %></td>
                                        <td class="xiangxi1">
                                            <asp:LinkButton ID="LBTdelete" runat="server" CommandName="Select" CommandArgument='<%#Eval("teamname") %>'>详细
                                            </asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div style="margin-top:40px;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                            <Columns>
                                ...
                                <asp:BoundField DataField="goaldifference" HeaderText="净胜数" />
