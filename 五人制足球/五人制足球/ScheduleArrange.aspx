<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScheduleArrange.aspx.cs" Inherits="五人制足球.ScheduleArrange" %>
                ...
                <div class="compitioncontent">
                    ...
                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Courtname" HeaderText="比赛地点" />
                            <asp:BoundField DataField="Judgername" HeaderText="裁判员" />
                            <asp:BoundField DataField="Timekeepername" HeaderText="计时员" />
                            <asp:BoundField DataField="TeamA" HeaderText="主场队伍" />
                            <asp:BoundField DataField="TeamB" HeaderText="客场队伍" />
                        </Columns>
                    </asp:GridView>
                </div>
            </div>
