...
namespace 五人制足球
{
    public partial class redyellowcard : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable ds = db.read("select top 1 turn from LeagueStanding order by turn desc", CommandType.Text).Tables[0];
            tur = ds.Rows[0]["turn"].ToString();
            SqlParameter teamn = new SqlParameter("@teamname", DropDownList1.SelectedValue);
            SqlParameter player = new SqlParameter("@playername", DropDownList2.SelectedValue);
            SqlParameter turn = new SqlParameter("@turn", tur);
            SqlParameter redcard = new SqlParameter("@redcard", TextBox1.Text);
            SqlParameter yellowcard = new SqlParameter("@yellowcard", TextBox2.Text);
            SqlParameter stoppturn = new SqlParameter("@stoppturn", TextBox3.Text);
            ...
            {
                db.command("insertredyellow", CommandType.StoredProcedure, teamn, player, turn, redcard, yellowcard, stoppturn, sprv);
