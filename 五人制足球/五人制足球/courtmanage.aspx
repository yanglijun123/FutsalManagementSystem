<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courtmanage.aspx.cs" Inherits="五人制足球.courtmanage" %>
        ...
        <div class="content">
            ...
            <div class="rightcontent" style="border: 1px solid #aaa; border-radius: 5px; height: 420px; margin-top: 10px;">
                ...
                <div class="login" style="margin-top: 20px;">
                    <%-- 球场名 --%>
                    <asp:Label ID="Label1" runat="server" Text="球场名称" CssClass="td1"></asp:Label>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="td2"></asp:TextBox>
                    <span style="color: red; margin-left: 0;" class="td3">*</span><br />
                    <%-- 类别--%>
                    <div style="margin-top: 10px;">
                        <asp:Label ID="Label3" runat="server" Text="球场地点" CssClass="td4"></asp:Label>
                ...
                <div class="pagetitle" style="width: 550px; margin-left: 20px; height: 40px; border-bottom: 1px solid #036; font-family: 楷体; line-height: 40px;text-align:center">
                    <i>编辑球场</i>
                </div>
                <div class="judge" style="text-align: center; margin-left: 180px; margin-top: 10px">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="true" OnRowCancelingEdit="GridView1_RowCancelingEdit" PageSize="5" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                        <Columns>
                            <asp:BoundField DataField="Courtname" HeaderText="球场名称" />
                            <asp:BoundField DataField="Courtplace" HeaderText="球场地点" />
                            <asp:CommandField ShowEditButton="True" HeaderText="编辑信息" />
                            <asp:TemplateField HeaderText="删除">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="Delete" CommandName="Delete" ImageUrl="~/delete.jpg" ToolTip="删除" Width="21px" Height="21px" OnClientClick="return confirm('是否确认删除该裁判信息？');" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
